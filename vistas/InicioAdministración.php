    ...
    <div>
        ...
        <section id="opciones">
            ...
            <div id="op_principales">
                <a href="../vistas/IngresoDeProductos.php">Ingresar Producto</a>
                <a href="../vistas/ActualizaciónDeInformación.php">Actualizar información</a>
                <a href="../vistas/EliminaciónDeProductos.php">Eliminar producto</a>
            </div>
        </section>
    </div>
</body>
