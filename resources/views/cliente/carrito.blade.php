...
@endsection
@section('navegacion')
    <input type="checkbox" id="check3" onchange="EnviarComprobanteACorreo()" style="position: absolute; top: 1000px">
                        ...
                        @foreach ($pasteles as $pastel)
                            <div class="fila datos_carrito">
                                ...
                                <input type="hidden" name="categoria"
                                    value="{{ $pastel_search->getPastelById($pastel->pastel_id)->getCategoriaPastel() }}">
                                <div class="col" id="seccion_eliminar">
                                    <div>
                                        <form
                                            action="{{ route('detalles_pedido.show', $detalles_pedido[$cont]->detalle_id) }}"
                                            method="GET">
                                            @csrf
                                        ...
                                        <form
                                            action="{{ route('detalles_pedido.destroy', $detalles_pedido[$cont]->detalle_id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
