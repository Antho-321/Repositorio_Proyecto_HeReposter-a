                        ...
                        <div class="row">
                            <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                                <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp"
                                        data-caption-delay="0">Descubre el nuevo sabor</span></h1>
                                <p class="big swiper-text add_txt" data-caption-animate="fadeInLeft"
                                    data-caption-delay="300">Con recetas tradicionales y un toque moderno.</p><a
                                    class="button button-lg button-primary button-winona button-shadow-2 btn_ver_destacados"
                                    href="#our-menu" data-caption-animate="fadeInUp" data-caption-delay="300">Ver productos
                                    destacados</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                                <h1 class="oh swiper-title"><span class="d-inline-block"
                                        data-caption-animate="slideInDown" data-caption-delay="0">Ingredientes de
                                        calidad</span></h1>
                                <p class="big swiper-text add_txt" data-caption-animate="fadeInRight"
                                    data-caption-delay="300">Solo los ingredientes más finos y exquisitos se usan para
                                    crear pasteles inigualables para nuestros clientes.</p>
                                <div class="button-wrap oh ver_destacados_container"><a
                                        class="button button-lg button-primary button-winona button-shadow-2 btn_ver_destacados"
                                        href="#our-menu" data-caption-animate="slideInUp" data-caption-delay="0">Ver
