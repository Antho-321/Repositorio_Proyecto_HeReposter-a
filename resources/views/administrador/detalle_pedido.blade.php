                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('AdministradorDetallePedidoIngresar') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtPastelId">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Cantidad Pastel</label>
                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtCantidadPastel">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword1" name="txtDedicatoria">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Especificacion Adicional</label>
                                        <input type="text" class="form-control" id="exampleInputPassword1" name="txtEspecificacionAdicional">
                                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('AdministradorDetallePedidoEliminar', $item->detalle_id) }}" onclick="return res()" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                                </td>
                                <!-- Modal  PARA EDITAR-->
                                <div class="modal fade" id="modalEditar{{ $item->detalle_id }}" tabindex="-1" aria-labelledby="modalEditarLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('AdministradorDetallePedidoActualizar') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Codigo</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtCodigo" value="{{ $item->detalle_id }}" readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Pedido Id</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtCedula" value="{{ $item->pedido_id }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Varios Id</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtNombre" value="{{ $item->id_varios }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Pastel Id</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtTelefono" value="{{ $item->pastel_id }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Cantidad Pastel</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtDireccion" value="{{ $item->cantidad_pastel }}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Cantidad Varios</label>
                                                        <input type="number" class="form-control" id="exampleInputPassword1" name="txtCorreo" value="{{ $item->cantidad_varios }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Dedicatoria</label>
                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="txtPassword" value="{{ $item->dedicatoria }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Especificacion Adicional</label>
                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="txtPassword" value="{{ $item->especificacion_adicional }}">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
