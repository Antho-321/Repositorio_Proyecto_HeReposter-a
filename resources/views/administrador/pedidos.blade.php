                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" data-bs-toggle="modal"
                                    data-bs-target="#modalEditar{{ $item->pedido_id }}"
                                    class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="{{ route('AdministradorPedidosEliminar', $item->pedido_id) }}"
                                    onclick="return res()" class="btn btn-danger btn-sm"><i
                                        class="fa-solid fa-trash"></i></a>
                            </td>
                            <!-- Modal  PARA EDITAR-->
                            <div class="modal fade" id="modalEditar{{ $item->pedido_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('AdministradorPedidosActualizar') }}"
                                                method="POST">
                                                @csrf
                                                <div class="mb-3">
