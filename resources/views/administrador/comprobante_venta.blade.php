                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('AdministradorComprobanteVentaIngresar') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="exampleInputPassword1" name="txtComprobanteId">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="exampleInputPassword1" name="txtFechaEntrega">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Total Pago</label>
                                            <input type="number" step="any" class="form-control" id="exampleInputPassword1" name="txtTotalPago">
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('AdministradorComprobanteVentaActualizar') }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Id Comprobante</label>
                                                            <input type="number" class="form-control" id="exampleInputPassword1" name="txtComprobanteId" value="{{ $item->comprobante_id }}" readonly>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Id Pedido</label>
                                                            <input type="number" class="form-control" id="exampleInputPassword1" name="txtPedidoId" value="{{ $item->pedido_id }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Fecha Entrega</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Total Pago</label>
                                                            <input type="number" step="any" class="form-control" id="exampleInputPassword1" name="txtTotalPago" value="{{ $item->total_pago }}">
                                                        </div>
