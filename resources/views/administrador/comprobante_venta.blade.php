                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" data-bs-toggle="modal"
                                    data-bs-target="#modalEditar{{ $item->comprobante_id }}"
                                    class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="{{ route('AdministradorComprobanteVentaEliminar', $item->comprobante_id) }}"
                                    onclick="return res()" class="btn btn-danger btn-sm"><i
                                        class="fa-solid fa-trash"></i></a>
                            </td>
                            <!-- Modal  PARA EDITAR-->
                            <div class="modal fade" id="modalEditar{{ $item->comprobante_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('AdministradorComprobanteVentaActualizar') }}"
                                                method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1"
                                                        class="form-label">Id Comprobante</label>
                                                    <input type="number" class="form-control"
                                                        id="exampleInputPassword1" name="txtCodigo"
                                                        value="{{ $item->comprobante_id }}" readonly>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1"
                                                        class="form-label">Id Pedido</label>
                                                    <input type="number" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1"
                                                        class="form-label">Cedula vendedor</label>
                                                    <input type="text" class="form-control"
